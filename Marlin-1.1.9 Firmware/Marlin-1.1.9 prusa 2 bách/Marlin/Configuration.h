...
#define STRING_CONFIG_H_AUTHOR "(Quoc Trung)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Ultimaker
  #define DEFAULT_Kp 35.2
  #define DEFAULT_Ki 3.35
  #define DEFAULT_Kd 92.47
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 722.30
  #define DEFAULT_bedKi 131.47
  #define DEFAULT_bedKd 992.08
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.03, 80, 400, 98 }
